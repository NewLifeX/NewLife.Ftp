...
public class FtpClient
{
    ...
    {
        get => Credentials is NetworkCredential;
    ...
    /// <param name="directory"></param>
    /// <returns></returns>
    public FtpDirectory ListDirectoryDetails(String directory) => new FtpDirectory(this, ListDirectoryDetailsString(directory), directory);
    ...
    /// <param name="path"></param>
    /// <returns></returns>
    private FtpWebRequest GetFtpRequest(String path) => GetFtpRequest(new Uri(AdjustDir(path)));
    ...
    {
        if (KeepAlive && _Request != null) return _Request;
